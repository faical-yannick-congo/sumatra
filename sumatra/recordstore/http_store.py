...
class HttpCoRRStore(RecordStore):
    ...
    def _get_record(self, project_id, label):
        ...
        if len(records) == 1:
            ...
            content['timestamp'] = records[0]['body']['content']['timestamp']
            content['reason'] = records[0]['body']['content']['reason']
            content['duration'] = records[0]['body']['content']['duration']
            content['executable'] = records[0]['body']['content']['executable']
            content['repository'] = records[0]['body']['content']['repository']
            content['main_file'] = records[0]['body']['content']['main_file']
            content['version'] = records[0]['body']['content']['version']
            content['parameters'] = records[0]['body']['content']['parameters']
            content['script_arguments'] = records[0]['body']['content']['script_arguments']
            content['datastore'] = records[0]['body']['content']['datastore']
            content['input_datastore'] = records[0]['body']['content']['input_datastore']
            content['outcome'] = records[0]['body']['content']['outcome']
            content['stdout_stderr'] = records[0]['body']['content']['stdout_stderr']
            content['diff'] = records[0]['body']['content']['diff']
            content['user'] = records[0]['body']['content']['user']
